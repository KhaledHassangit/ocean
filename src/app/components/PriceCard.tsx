...
import { Pricing, PricingMode } from "@/Types/intefaces";
...
const PricingCard: FC<PricingCardProps> = ({
    ...
    return (
        <article
            ...
            <figure
                className={`absolute w-72 h-60 bg-sky-600 -z-10 rounded-full blur-3xl opacity-20 -top-12 ${Position === "left" ? "-left-8" : "-right-8"}`}/>
            {isMostPopular && (
